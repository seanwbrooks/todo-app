...
describe('TodoDataService', () => {
    beforeEach(() => {
        ...
        this.todo1 = new Todo({title: 'Hello 1', complete: false});
        this.todo2 = new Todo({title: 'Hello 2', complete: true});
    });
    ...
    describe('#getAllTodos()', () => {
        ...
        it('should return all todos', inject([TodoDataService], (service: TodoDataService) => {
            service.addTodo(this.todo1);
            service.addTodo(this.todo2);
            expect(service.getAllTodos()).toEqual([this.todo1, this.todo2]);
        }));
    ...
    describe('#save(todo)', () => {
        ...
        it('should automatically assign an incrementing id', inject([TodoDataService], (service: TodoDataService) => {
            service.addTodo(this.todo1);
            service.addTodo(this.todo2);
            expect(service.getTodoById(1)).toEqual(this.todo1);
            expect(service.getTodoById(2)).toEqual(this.todo2);
        }));
    ...
    describe('#deleteTodoById(id)', () => {
        ...
        it('should remove todo with the corresponding id', inject([TodoDataService], (service: TodoDataService) => {
            ...
            expect(service.getAllTodos()).toEqual([this.todo2]);
